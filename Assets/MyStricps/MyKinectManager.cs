...
public class MyKinectManager : MonoBehaviour 
{
	...
	public GameObject CameraPlanePostion;
...
//	public bool startKinectServer = true;
	...
	private static MyKinectManager instance = null;
...
//			}
		...
		if(computeUserMap)
		{
			...
			usersMapRect = new Rect((cameraRect.width-cameraRect.width * MapsPercentWidth/MapsPercentHeight)/2, cameraRect.height, cameraRect.width * MapsPercentWidth/MapsPercentHeight, -cameraRect.height  );
		...
		if(computeColorMap)
		{
	        ...
	        usersClrRect = new Rect(0.0f, cameraRect.height, cameraRect.width, -cameraRect.height );
...
//						}
	...
	void UpdateColorMap()
	{
		...
		CameraPlanePostion.GetComponent<Renderer>().material.mainTexture = usersClrTex;
	}
...
//				}
	...
	{
		int width = KinectInterop.Constants.ColorImageWidth;
		int height = KinectInterop.Constants.ColorImageHeight;
