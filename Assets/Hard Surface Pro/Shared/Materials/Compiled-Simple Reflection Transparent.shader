Shader "AboutCG 101/Reflective Transparent/Simple Reflection Transparent" {
Properties {
...
MAD R0.xyz, -R0, c[5].y, fragment.texcoord[2];
...
DP3 R0.x, fragment.texcoord[1], R0;
MUL R0.xyz, fragment.texcoord[1], R0.x;
MAD R1.xyz, -R0, c[3].y, fragment.texcoord[2];
MOV result.color.w, c[2].x;
TEX R2.xyz, -R1, texture[1], CUBE;
